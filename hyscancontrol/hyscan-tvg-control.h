 ...
 * распространённым методом управления системой ВАРУ при боковом обзоре.
 *
 ...
 * возможного усиления. Максимально возможное усление можно определить с помощью функции
 * #hyscan_tvg_control_get_gain_range. Величина изменения усиления должна находится
 * в пределах от 0 до 40 дБ.
 *
 * \param control указатель на класс \link HyScanTVGControl \endlink;
 * \param source идентификатор источника данных;
 ...
 * Начальный уровень усиления должен находится в пределах от -20 дБ, до максимально
 * возможного усиления. Максимально возможное усление можно определить с помощью функции
 * #hyscan_tvg_control_get_gain_range. Значение коэффициента поглощения цели должно
 * находится в пределах от 0 дБ до 40 дБ. Значение коэффициента затухания должно
 * находится в пределах от -1 дБ/м до 1 дБ/м.
 *
 * \param control указатель на класс \link HyScanTVGControl \endlink;
 * \param source идентификатор источника данных;
 * \param gain0 начальный уровень усиления, дБ;
